...
namespace Lean.Texture
{
    ...
    public class LeanCreateSimplex : LeanCreate
    {
        ...
        public float Frequency { set { frequency = value; } get { return frequency; } }
        [SerializeField] private float frequency = 5.0f;

        /// <summary>The amount of noise layers that get mixed together.</summary>
        public int Octaves { set { octaves = value; } get { return octaves; } }
        [SerializeField][Range(1, 25)] private int octaves = 1;

        /// <summary>The random seed used when generating the noise.</summary>
        public int Seed { set { seed = value; } get { return seed; } }
