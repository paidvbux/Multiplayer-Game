...
namespace Lean.Texture
{
    ...
    public class LeanFilterInvert : LeanFilter
    {
        ...
        [SerializeField][Range(0.0f, 1.0f)] private float strength = 1.0f;

        /// <summary>The strength of the inversion.</summary>
        public float StrengthR { set { strengthR = value; } get { return strengthR; } }
        [SerializeField][Range(0.0f, 1.0f)] private float strengthR = 1.0f;

        /// <summary>The strength of the inversion.</summary>
        public float StrengthG { set { strengthG = value; } get { return strengthG; } }
        [SerializeField][Range(0.0f, 1.0f)] private float strengthG = 1.0f;

        /// <summary>The strength of the inversion.</summary>
        public float StrengthB { set { strengthB = value; } get { return strengthB; } }
        [SerializeField][Range(0.0f, 1.0f)] private float strengthB = 1.0f;

        /// <summary>The strength of the inversion.</summary>
        public float StrengthA { set { strengthA = value; } get { return strengthA; } }
        [SerializeField][Range(0.0f, 1.0f)] private float strengthA = 1.0f;
