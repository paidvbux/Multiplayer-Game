...
namespace Lean.Texture
{
    ...
    public class LeanFilterMirror : LeanFilter
    {
        ...
        public bool2 MirrorAxes { set { mirrorAxes = value; } get { return mirrorAxes; } }
        [SerializeField] private bool2 mirrorAxes;

        /// <summary>The horizontal and vertices axes that will be mirrored.</summary>
        public bool2 MirrorAxesR { set { mirrorAxesR = value; } get { return mirrorAxesR; } }
        [SerializeField] private bool2 mirrorAxesR;

        /// <summary>The horizontal and vertices axes that will be mirrored.</summary>
        public bool2 MirrorAxesG { set { mirrorAxesG = value; } get { return mirrorAxesG; } }
        [SerializeField] private bool2 mirrorAxesG;

        /// <summary>The horizontal and vertices axes that will be mirrored.</summary>
        public bool2 MirrorAxesB { set { mirrorAxesB = value; } get { return mirrorAxesB; } }
        [SerializeField] private bool2 mirrorAxesB;

        /// <summary>The horizontal and vertices axes that will be mirrored.</summary>
        public bool2 MirrorAxesA { set { mirrorAxesA = value; } get { return mirrorAxesA; } }
        [SerializeField] private bool2 mirrorAxesA;
