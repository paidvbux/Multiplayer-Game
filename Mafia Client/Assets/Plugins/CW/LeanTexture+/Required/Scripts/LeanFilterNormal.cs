...
namespace Lean.Texture
{
    ...
    public class LeanFilterNormal : LeanFilter
    {
        ...
        public float Influence2 { set { influence2 = value; } get { return influence2; } }
        [SerializeField][Range(0.0f, 1.0f)] private float influence2 = 1.0f;

        /// <summary>The contribution to the output normals based on 4 samples across each axis.</summary>
        public float Influence4 { set { influence4 = value; } get { return influence4; } }
        [SerializeField][Range(0.0f, 1.0f)] private float influence4 = 1.0f;
