...
namespace Lean.Texture
{
    ...
    public class LeanFilterOffset : LeanFilter
    {
        ...
        public ChannelType Channel { set { channel = (int)value; } get { return (ChannelType)channel; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int channel;

        /// <summary>The coordinate space of the offset.</summary>
        public CoordinateType Coordinate { set { coordinate = (int)value; } get { return (CoordinateType)coordinate; } }
        [SerializeField][LeanEnum(typeof(CoordinateType))] private int coordinate = (int)CoordinateType.Pixels;

        /// <summary>The amount the texture will be shifted across the x (right) and y (up) axes.</summary>
        public float2 Offset { set { offset = value; } get { return offset; } }
        [SerializeField] private float2 offset;

        /// <summary>The amount the texture will be shifted across the x (right) and y (up) axes.</summary>
        public float2 OffsetR { set { offsetR = value; } get { return offsetR; } }
        [SerializeField] private float2 offsetR;

        /// <summary>The amount the texture will be shifted across the x (right) and y (up) axes.</summary>
        public float2 OffsetG { set { offsetG = value; } get { return offsetG; } }
        [SerializeField] private float2 offsetG;

        /// <summary>The amount the texture will be shifted across the x (right) and y (up) axes.</summary>
        public float2 OffsetB { set { offsetB = value; } get { return offsetB; } }
        [SerializeField] private float2 offsetB;

        /// <summary>The amount the texture will be shifted across the x (right) and y (up) axes.</summary>
        public float2 OffsetA { set { offsetA = value; } get { return offsetA; } }
        [SerializeField] private float2 offsetA;
