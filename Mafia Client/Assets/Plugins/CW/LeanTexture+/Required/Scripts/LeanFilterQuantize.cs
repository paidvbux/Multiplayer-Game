...
namespace Lean.Texture
{
    ...
    public class LeanFilterQuantize : LeanFilter
    {
        ...
        public int Values { set { values = value; } get { return values; } }
        [SerializeField][Range(2, 256)] private int values = 256;

        /// <summary>The amount of possible values this channel can have.</summary>
        public int ValuesR { set { valuesR = value; } get { return valuesR; } }
        [SerializeField][Range(2, 256)] private int valuesR = 256;

        /// <summary>The amount of possible values this channel can have.</summary>
        public int ValuesG { set { valuesG = value; } get { return valuesG; } }
        [SerializeField][Range(2, 256)] private int valuesG = 256;

        /// <summary>The amount of possible values this channel can have.</summary>
        public int ValuesB { set { valuesB = value; } get { return valuesB; } }
        [SerializeField][Range(2, 256)] private int valuesB = 256;

        /// <summary>The amount of possible values this channel can have.</summary>
        public int ValuesA { set { valuesA = value; } get { return valuesA; } }
        [SerializeField][Range(2, 256)] private int valuesA = 256;
