...
namespace Lean.Texture
{
    ...
    public class LeanFilterReplace : LeanFilter
    {
        ...
        public Color OldColor { set { oldColor = value; } get { return oldColor; } }
        [SerializeField] private Color oldColor = Color.red;

        /// <summary>The color that it will be replaced with.</summary>
        public Color NewColor { set { newColor = value; } get { return newColor; } }
        ...
        public DistanceType Distance { set { distance = value; } get { return distance; } }
        [SerializeField] private DistanceType distance;

        /// <summary>The <b>OldColor</b> can be off by this much.</summary>
        public float Threshold { set { threshold = value; } get { return threshold; } }
        [SerializeField][Range(0.0f, 1.0f)] private float threshold = 0.01f;

        /// <summary>How much should colors outside the <b>Threshold</b> be replaced?</summary>
        public float Edge { set { edge = value; } get { return edge; } }
        [SerializeField][Range(0.0f, 1.0f)] private float edge = 0.1f;

        /// <summary>The overall color replacement strength.</summary>
        public float Opacity { set { opacity = value; } get { return opacity; } }
        [SerializeField][Range(0.0f, 1.0f)] private float opacity = 1.0f;
