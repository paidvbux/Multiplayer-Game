...
namespace Lean.Texture
{
    ...
    public class LeanFilterSeamless : LeanFilter
    {
        ...
        public float Thickness { set { thickness = value; } get { return thickness; } }
        [SerializeField][Range(0.01f, 1.0f)] private float thickness = 0.5f;

        /// <summary>The position along the texture the seam will be filled in with.</summary>
        public float OffsetX { set { offsetX = value; } get { return offsetX; } }
        [SerializeField][Range(0.0f, 1.0f)] private float offsetX = 0.5f;

        /// <summary>The position along the texture the seam will be filled in with.</summary>
        public float OffsetY { set { offsetY = value; } get { return offsetY; } }
        [SerializeField][Range(0.0f, 1.0f)] private float offsetY = 0.5f;

        /// <summary>The texture transition will be modified based on height data from this aspect of the pixels.</summary>
        public LeanHeight.Source HeightSource { set { heightSource = (int)value; } get { return (LeanHeight.Source)heightSource; } }
        [SerializeField][LeanEnum(typeof(LeanHeight.Source))] private int heightSource = (int)LeanHeight.Source.Luminance;

        /// <summary>The amount of impact the height data has on the transition.</summary>
        public float HeightInfluence { set { heightInfluence = value; } get { return heightInfluence; } }
        [SerializeField][Range(0.0f, 1.0f)] private float heightInfluence = 1.0f;

        /// <summary>The frequency of the noise data.</summary>
        public float NoiseTiling { set { noiseTiling = value; } get { return noiseTiling; } }
        [SerializeField][Range(1.0f, 20.0f)] private float noiseTiling = 5.0f;

        /// <summary>The amount of impact the noise data has on the transition.</summary>
        public float NoiseInfluence { set { noiseInfluence = value; } get { return noiseInfluence; } }
        [SerializeField][Range(0.0f, 0.5f)] private float noiseInfluence = 0.5f;
