...
namespace Lean.Texture
{
    ...
    public class LeanFilterSharpen : LeanFilter
    {
        ...
        public ChannelType Channels { set { channels = (int)value; } get { return (ChannelType)channels; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int channels;
        ...
        [SerializeField][Range(0.0f, 10.0f)] private float multiplier = 1.0f;

        /// <summary>The sharpness of the texture will be multiplied by this value.</summary>
        public float MultiplierR { set { multiplierR = value; } get { return multiplierR; } }
        [SerializeField][Range(0.0f, 10.0f)] private float multiplierR = 1.0f;

        /// <summary>The sharpness of the texture will be multiplied by this value.</summary>
        public float MultiplierG { set { multiplierG = value; } get { return multiplierG; } }
        [SerializeField][Range(0.0f, 10.0f)] private float multiplierG = 1.0f;

        /// <summary>The sharpness of the texture will be multiplied by this value.</summary>
        public float MultiplierB { set { multiplierB = value; } get { return multiplierB; } }
        [SerializeField][Range(0.0f, 10.0f)] private float multiplierB = 1.0f;

        /// <summary>The sharpness of the texture will be multiplied by this value.</summary>
        public float MultiplierA { set { multiplierA = value; } get { return multiplierA; } }
        [SerializeField][Range(0.0f, 10.0f)] private float multiplierA = 1.0f;
