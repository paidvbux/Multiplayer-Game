...
namespace Lean.Texture
{
    ...
    public class LeanCreateGradient : LeanCreate
    {
        ...
        public int2 Size { set { size = value; } get { return size; } }
        [SerializeField] private int2 size = new int2(1024, 1024);

        /// <summary>The first color of the gradient.</summary>
        public Color ColorA { set { colorA = value; } get { return colorA; } }
        [SerializeField] private Color colorA = Color.white;

        /// <summary>The second color of the gradient.</summary>
        public Color ColorB { set { colorB = value; } get { return colorB; } }
        ...
        [SerializeField][LeanEnum(typeof(CoordinateType))] private int coordinate;

        /// <summary>The first point of the gradient.</summary>
        public float2 PointA { set { pointA = value; } get { return pointA; } }
        [SerializeField] private float2 pointA;

        /// <summary>The second point of the gradient.</summary>
        public float2 PointB { set { pointB = value; } get { return pointB; } }
        [SerializeField] private float2 pointB = new float2(1.0f, 1.0f);
