...
namespace Lean.Texture
{
    ...
    public class LeanCreateTextureCombined : LeanCreate
    {
        ...
        public UnityEngine.Texture RedTexture { set { redTexture = value; } get { return redTexture; } }
        [SerializeField] private UnityEngine.Texture redTexture;

        /// <summary>The channel from the <b>RedTexture</b> that will be stored in the created texture's <b>Red</b> channel.</summary>
        public ChannelType RedChannel { set { redChannel = (int)value; } get { return (ChannelType)redChannel; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int redChannel = (int)ChannelType.Red;

        /// <summary>The texture that will be stored in the <b>Green</b> channel of the created texture.</summary>
        public UnityEngine.Texture GreenTexture { set { greenTexture = value; } get { return greenTexture; } }
        [SerializeField] private UnityEngine.Texture greenTexture;

        /// <summary>The channel from the <b>GreenTexture</b> that will be stored in the created texture's <b>Green</b> channel.</summary>
        public ChannelType GreenChannel { set { greenChannel = (int)value; } get { return (ChannelType)greenChannel; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int greenChannel = (int)ChannelType.Green;

        /// <summary>The texture that will be stored in the <b>Blue</b> channel of the created texture.</summary>
        public UnityEngine.Texture BlueTexture { set { blueTexture = value; } get { return blueTexture; } }
        [SerializeField] private UnityEngine.Texture blueTexture;

        /// <summary>The channel from the <b>BlueTexture</b> that will be stored in the created texture's <b>Blue</b> channel.</summary>
        public ChannelType BlueChannel { set { blueChannel = (int)value; } get { return (ChannelType)blueChannel; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int blueChannel = (int)ChannelType.Blue;

        /// <summary>The texture that will be stored in the <b>Alpha</b> channel of the created texture.</summary>
        public UnityEngine.Texture AlphaTexture { set { alphaTexture = value; } get { return alphaTexture; } }
        [SerializeField] private UnityEngine.Texture alphaTexture;

        /// <summary>The channel from the <b>alphaTexture</b> that will be stored in the created texture's <b>alpha</b> channel.</summary>
        public ChannelType AlphaChannel { set { alphaChannel = (int)value; } get { return (ChannelType)alphaChannel; } }
        [SerializeField][LeanEnum(typeof(ChannelType))] private int alphaChannel = (int)ChannelType.Alpha;
        ...
        public int2 OverrideSize { set { overrideSize = value; } get { return overrideSize; } }
        [SerializeField] private int2 overrideSize = new int2(-1, -1);
