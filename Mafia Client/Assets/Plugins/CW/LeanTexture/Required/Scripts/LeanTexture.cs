...
namespace Lean.Texture
{
    ...
    public class LeanTexture
    {
        ...
        public PresetType Preset { set { preset = value; } get { return preset; } }
        [SerializeField] private PresetType preset = PresetType.ColorPlusAlpha;
        ...
        public Texture2D SettingsFrom { set { settingsFrom = value; } get { return settingsFrom; } }
        [SerializeField] private Texture2D settingsFrom;
        ...
        public TextureWrapMode WrapModeU { set { wrapModeU = value; } get { return wrapModeU; } }
        [SerializeField] private TextureWrapMode wrapModeU;

        /// <summary>If <b>SettingsFrom</b> is set to None/null, then this allows you to specify the wrap mode of the generated texture.</summary>
        public TextureWrapMode WrapModeV { set { wrapModeV = value; } get { return wrapModeV; } }
        [SerializeField] private TextureWrapMode wrapModeV;
        ...
        public bool MipmapEnabled { set { mipmapEnabled = value; } get { return mipmapEnabled; } }
        [SerializeField] private bool mipmapEnabled;

        /// <summary>The texture will begin with this creation method.</summary>
        public LeanCreate Create { set { create = value; } get { return create; } }
        [SerializeReference] private LeanCreate create;

        /// <summary>The texture will then be modified by these filters.</summary>
        public List<LeanFilter> Filters { get { if (filters == null) filters = new List<LeanFilter>(); return filters; } }
        [SerializeReference] private List<LeanFilter> filters;
